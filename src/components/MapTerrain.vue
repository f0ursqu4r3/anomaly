<template>
  <svg class="map-terrain" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid meet">
    ...
    <path
      d="M76,73 Q78,71 81,72"
      fill="none"
      stroke="rgba(100,110,130,0.1)"
      stroke-width="0.4"
    ...
    <circle
      ...
      cy="88"
      r="2.5"
      fill="url(#terrain-crater-shadow-sm)"
      stroke="rgba(80,90,110,0.06)"
      stroke-width="0.15"
    />
    <circle
      cx="90"
    ...
    <circle
      ...
      r="1.5"
      fill="url(#terrain-crater-shadow-sm)"
      stroke="rgba(80,90,110,0.05)"
      stroke-width="0.1"
    />

    <!-- Rock ridges -->
    <path
      d="M5,82 Q12,78 20,80 Q25,82 30,79"
      fill="none"
      stroke="rgba(80,90,110,0.08)"
      stroke-width="0.5"
      stroke-linecap="round"
    />
    <path
      d="M70,92 Q78,88 85,90 Q90,92 95,88"
      fill="none"
      stroke="rgba(80,90,110,0.07)"
      stroke-width="0.4"
      stroke-linecap="round"
    />
    <path
      d="M88,45 Q92,42 96,44"
      fill="none"
      stroke="rgba(80,90,110,0.06)"
      stroke-width="0.3"
      stroke-linecap="round"
    ...
    <path
      d="M0,75 Q25,68 50,72 Q75,76 100,70"
      fill="none"
      stroke="rgba(70,80,100,0.04)"
      stroke-width="1.5"
    />
    <path
      d="M0,35 Q20,30 45,33 Q70,37 100,32"
      fill="none"
      stroke="rgba(70,80,100,0.03)"
      stroke-width="1.2"
    />
    ...
    <ellipse
      ...
      rx="11"
      ry="8"
      fill="rgba(20,25,35,0.25)"
      stroke="rgba(60,70,85,0.04)"
      stroke-width="0.3"
    />
    ...
    <ellipse
      :cx="zones.extraction.x"
      :cy="zones.extraction.y"
      rx="11"
      ry="8"
      fill="rgba(22,28,38,0.2)"
    />
    <line
      :x1="zones.extraction.x - 5"
      :y1="zones.extraction.y - 2"
      :x2="zones.extraction.x - 3"
      :y2="zones.extraction.y + 3"
      stroke="rgba(52,211,153,0.03)"
      stroke-width="0.4"
    />
    <line
      :x1="zones.extraction.x + 2"
      :y1="zones.extraction.y - 3"
      :x2="zones.extraction.x + 4"
      :y2="zones.extraction.y + 2"
      stroke="rgba(52,211,153,0.03)"
      stroke-width="0.3"
    />
    ...
    <line
      :x1="zones.storage.x - 3"
      :y1="zones.storage.y"
      :x2="zones.storage.x + 3"
      :y2="zones.storage.y"
      stroke="rgba(136,136,136,0.03)"
      stroke-width="0.3"
    />
    <line
      :x1="zones.storage.x"
      :y1="zones.storage.y - 2"
      :x2="zones.storage.x"
      :y2="zones.storage.y + 2"
      stroke="rgba(136,136,136,0.03)"
      stroke-width="0.3"
    />
    ...
    <ellipse
      ...
      rx="8"
      ry="6"
      fill="rgba(22,28,38,0.18)"
    />
    <line
      :x1="zones.workshop.x - 3"
      :y1="zones.workshop.y + 1"
      :x2="zones.workshop.x + 2"
      :y2="zones.workshop.y - 2"
